"""
---
name: test-llm-provider-crud
description: "Provider CRUD service tests"
type: test-suite
target:
  layer: backend
  domain: llm
run:
  command: "PYTHONPATH=.:backend:tests python -m pytest tests/test_llm_provider_crud.py -v"
  env: {}
  prerequisites:
    - "Python deps installed"
expected:
  pass: all
  output: "PASS/FAIL per provider CRUD test case"
---

Unit tests for the Provider CRUD service (backend/core/ai_providers.py).

All database interactions are mocked with in-memory fakes.
"""
