"""
---
name: test-llm-fallback
description: "Fallback engine tests"
type: test-suite
target:
  layer: backend
  domain: llm
run:
  command: "PYTHONPATH=.:backend:tests python -m pytest tests/test_llm_fallback.py -v"
  env: {}
  prerequisites:
    - "Python deps installed"
expected:
  pass: all
  output: "PASS/FAIL per fallback test case"
---

Tests for LLM service: chain resolution and fallback execution.
"""
