...
test.skip('email change shows pending verification banner', async ({ page }) => {
  /**
...
test.skip('pending email is cleared once verification link is used', async ({ page }) => {
  /**
...
test.skip('username field rejects uppercase characters', async ({ page }) => {
  /**
...
test.skip('username field rejects digits and special chars', async ({ page }) => {
  /**
...
test.skip('username field rejects reserved names', async ({ page }) => {
  /**
...
test.skip('duplicate username shows conflict error', async ({ page }) => {
  /**
...
test.skip('password change with wrong current password shows error', async ({ page }) => {
  /**
...
test.skip('password change success shows session revocation notice', async ({ page }) => {
  /**
...
test.skip('avatar upload accepts jpeg file', async ({ page }) => {
  /**
...
test.skip('avatar upload rejects svg file', async ({ page }) => {
  /**
...
test.skip('avatar upload rejects oversized file', async ({ page }) => {
  /**
...
test.skip('avatar delete restores default state', async ({ page }) => {
  /**
...
test.skip('gravatar is off by default', async ({ page }) => {
  /**
...
test.skip('gravatar optin enables gravatar avatar source', async ({ page }) => {
  /**
